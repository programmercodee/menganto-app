...
export default function CheckOut() {
  return (
    <div>
      <section class="h-full bg-gray-100 py-12 sm:py-16 lg:py-20">
      ...
      <div class="bg-white shadow">
        <div class="px-4 py-6 sm:px-8 sm:py-10">
            ...
            <ul class="-my-8">
              <li class="flex flex-col space-y-3 py-6 text-left sm:flex-row sm:space-x-5 sm:space-y-0">
                <div class="shrink-0 flex justify-between">
                  <img class="h-24 w-24 max-w-full rounded-lg object-cover" src="https://flowbite.s3.amazonaws.com/docs/gallery/masonry/image-5.jpg" alt="" />
                  <button type="button" class="flex h-9 rounded p-2 text-center text-gray-500 transition-all duration-200 ease-in-out focus:shadow hover:text-gray-900 sm:hidden">
                ...
                <div class="relative flex flex-1 flex-col justify-between">
                  ...
                  <div class="absolute top-0 right-0 flex sm:bottom-0 sm:top-0">
                    <button type="button" class="flex h-9 rounded text-center text-gray-500 transition-all duration-200 ease-in-out focus:shadow hover:text-gray-900 ">
                      <svg class="h-5 w-5 hidden sm:block" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" class=""></path>
                      </svg>
                    </button>
                  </div>
          ...
          <div class="mt-6 flex items-center justify-between">
            ...
            <p class="text-2xl font-semibold text-gray-900"><span class="text-xs font-normal text-gray-400">Rs</span> 408.00</p>
          </div>
