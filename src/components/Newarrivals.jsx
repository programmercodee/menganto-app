...
export default function Newarrivals() {
  ...
  const [showcolorbtn, setshowcolorbtn] = useState({
    display: "none",
  });
  ...
  return (
    ...
    --> */}
            <div class="relative z-40 lg:hidden " style={mystyle} role="dialog" aria-modal="true">
              {/* <!--
      ...
      --> */}
          ...
          Leaving: "transition ease-in-out duration-300 transform"
            ...
            To: "translate-x-full"
        --> */}
                <div class="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl opacity-">
                  <div class="flex items-center justify-between px-4">
                    ...
                    <button type="button" class="-mr-2 flex h-10 w-10 items-center justify-center rounded-md bg-white p-2 text-gray-400">
                      ...
                      <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" onClick={Hide}>
                  ...
                  <form class="mt-4 border-t border-gray-200 " >
                    ...
                    <div class="border-t border-gray-200 px-4 py-6">
                      <h3 class="-mx-2 -my-3 flow-root">
                        ...
                        <button type="button" class="flex w-full items-center justify-between bg-white px-2 py-3 text-gray-400 hover:text-gray-500" aria-controls="filter-section-mobile-0" aria-expanded="false" >
                          ...
                          <span class="ml-6 flex items-center">
                            ...
                            <svg class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" onClick={Showlist}  style={btnhide}>
                              <path d="M10.75 4.75a.75.75 0 00-1.5 0v4.5h-4.5a.75.75 0 000 1.5h4.5v4.5a.75.75 0 001.5 0v-4.5h4.5a.75.75 0 000-1.5h-4.5v-4.5z" />
                            </svg>
                            {/* <!-- Collapse icon, show/hide based on section open state. --> */}
                            <svg class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" style={showcolorbtn} onClick={Showlist}>
                      ...
                      <div class="pt-6" id="filter-section-mobile-0 " style={show}>
                        <div class="space-y-6 ">
                    ...
                    <div class="border-t border-gray-200 px-4 py-6 ">
                      ...
                      {/* <!-- Filter section, show/hide based on section state. --> */}
                      <div class="pt-6 " id="filter-section-mobile-1" style={show}>
                        <div class="space-y-6 ">
                          <div class="flex items-center ">
                    ...
                    <div class="border-t border-gray-200 px-4 py-6">
                      ...
                      {/* <!-- Filter section, show/hide based on section state. --> */}
                      <div class="pt-6" id="filter-section-mobile-2" style={show}>
                        <div class="space-y-6">
                          <div class="flex items-center">
              ...
              <div class="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
                ...
                <div class="flex items-center">
                  <div class="relative inline-block text-left">
                    <div className=''>
                      <button type="button" class="group inline-flex justify-center text-sm font-medium text-gray-700 hover:text-gray-900" id="menu-button" aria-expanded="false" aria-haspopup="true" onClick={Show_Hide}>
                        Sort
            ...
            --> */}
                    <div class="show absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-white shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1" style={mystyle1}>
                ...
                --> */}
                  ...
                  <button type="button" class="-m-2 ml-4 p-2 text-gray-400 hover:text-gray-500 sm:ml-6 lg:hidden">
                    ...
                    <svg class="h-5 w-5" aria-hidden="true" viewBox="0 0 20 20" fill="currentColor" onClick={Show}>
                ...
                <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                  ...
                  <form class="hidden lg:block">
                    ...
                    <div class="border-b border-gray-200 py-6">
                      <h3 class="-my-3 flow-root">
                        ...
                        <button type="button" class="flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500" aria-controls="filter-section-0" aria-expanded="false">
                          ...
                          <span class="ml-6 flex items-center">
                            ...
                            {/* <!-- Collapse icon, show/hide based on section open state. --> */}
                            <svg class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" onClick={Showlist}  style={showcolorbtn}>
                              <path fill-rule="evenodd" d="M4 10a.75.75 0 01.75-.75h10.5a.75.75 0 010 1.5H4.75A.75.75 0 014 10z" clip-rule="evenodd" />
                            </svg>
                          </span>
                        </button>
                      ...
                      {/* <!-- Filter section, show/hide based on section state. --> */}
                      <div class="pt-6 " id="filter-section-0" style={show}>
                        <div class="space-y-4">
                          <div class="flex items-center">
                    ...
                    <div class="border-b border-gray-200 py-6">
                      ...
                      {/* <!-- Filter section, show/hide based on section state. --> */}
                      <div class="pt-6" id="filter-section-1" style={show}>
                        <div class="space-y-4">
                          <div class="flex items-center">
                    ...
                    <div class="border-b border-gray-200 py-6">
                      ...
                      {/* <!-- Filter section, show/hide based on section state. --> */}
                      <div class="pt-6" id="filter-section-2" style={show}>
                        <div class="space-y-4">
                          <div class="flex items-center">
                  ...
                  <div class="lg:col-span-3">
                    ...
                    <div className="bg-white">
                      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
                        <h2 className="text-2xl font-bold tracking-tight text-gray-900">New arrivals Section</h2>
